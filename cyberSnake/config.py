...
COLOR_SNAKE_TRAIL_P1 = tuple((c // 2) for c in COLOR_SNAKE_P1)
COLOR_SNAKE_TRAIL_P2 = tuple((c // 2) for c in COLOR_SNAKE_P2)
COLOR_SNAKE_TRAIL_ENEMY = tuple((c // 2) for c in COLOR_ENEMY_SNAKE)
